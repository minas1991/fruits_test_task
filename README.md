## Project set up on local environment

### Before cloning the project, make sure you have:
* PHP 8.2 and PHP extensions: Ctype, iconv, PCRE, Session, SimpleXML, and Tokenizer.
* MySQL database
* PHP [Composer](https://getcomposer.org/) dependency manager.
* [Symfony CLI](https://symfony.com/download) tool

### After cloning the project:
* Go to the project root directory 
* Open `.env` file and replace the line:
  ```
  DATABASE_URL="mysql://root:root@127.0.0.1:3306/fruits_db?serverVersion=8&charset=utf8mb4" 
  ```
  with your local MySQL username, password and with your preferable database name
* Run `composer install` the project root directory <br>
* Run `npm install` the project root directory <br>
* Run `php bin/console doctrine:migration:migrate` to create the database with tables structure
* Run `php bin/console fruit:fetch` to fill fruits data from https://fruityvice.com
* Run `symfony server:start` and app should be available in http://127.0.0.1:8000
* The list of fruits page: http://127.0.0.1:8000
* The list of favorite fruits page: http://127.0.0.1:8000/favorites
* API documentation available in http://127.0.0.1:8000/api
